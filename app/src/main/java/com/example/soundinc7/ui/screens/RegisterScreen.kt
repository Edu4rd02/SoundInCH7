...
import com.example.soundinc7.ui.RegisterViewModel
...
fun RegisterScreen(
    ...
    val isFormNotEmpty = name.isNotBlank() || email.isNotBlank() || password.isNotBlank() ||
            passwordConfirm.isNotBlank() || birthDate.isNotBlank() ||
            genre.isNotBlank()

    BackHandler(enabled = isFormNotEmpty) {
        showBackDialog = true
    }
    ...
    if (showBackDialog){
        AlertDialog(
            ...
            text = { Text("You have unsaved information. Are you sure you want to go back to the login screen?") },
            confirmButton = {
                TextButton(onClick = {
